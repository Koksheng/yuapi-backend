...
using yuapi.RPC.ServiceCenter.Services;
...
builder.Services.AddScoped<IUserRepository, UserRepository>(); // Ensure your repository is registered
builder.Services.AddScoped<IInterfaceInfoRepository, InterfaceInfoRepository>(); // Ensure your repository is registered
...
app.MapGrpcService<InterfaceInfoService>();
app.MapGrpcService<QuotaCheckService>();
